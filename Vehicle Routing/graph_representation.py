# Credit to https://github.com/AsishMandoi/VRP-explorations.git
...
def generate_vrp_instance(n, seed=None):
    ...
    for ii in range(n + 1):
        for jj in range(ii + 1, n + 1):
            cost_matrix[ii, jj] = (xc[ii] - xc[jj]) ** 2 + (yc[ii] - yc[jj]) ** 2
            cost_matrix[jj, ii] = cost_matrix[ii, jj]

    # Return output
    return cost_matrix, xc, yc
